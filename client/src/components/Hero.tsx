...
export default function Hero() {
    ...
    const trustedUserImages = [assets.aiemilHero, assets.aiemilHeadphones, assets.aiemilCamera];

    const mainImageUrl = assets.aiemilHero;

    const galleryStripImages = [assets.aiemilHero, assets.aiemilHeadphones, assets.aiemilCamera];
                ...
                <div className="max-w-6xl mx-auto px-4 max-md:w-screen max-md:overflow-hidden pt-32 xl:pt-40 pb-20 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                        <div className="text-left">
                            ...
                            >
                                Upload product images and a model photo — Aimakevision instantly produces professional lifestyle imagery and short-form videos optimized for commercials and Reels.
                            </motion.p>
