  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      ...
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40"> 
        ...
        <Title heading='Create In-Context Image' description="Upload your model and product images to create stunning branded content, short-form videos and social media posts with Aimakevision"/>
